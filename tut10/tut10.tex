	...
	\begin{minipage}{\dimexpr0.5\linewidth-\fboxrule-\fboxsep}
		\begin{center}
			\begin{tikzpicture}[scale=0.5]
				...
				\only<3-16>{\draw[onslide={<3>{fill=cdpurple!10}}, onslide={<16>{fill=cdorange!10}}] (0,0) rectangle ++(2,1) node[midway] {(8,1)};}
				\only<3,4>{\draw[onslide={<3>{fill=cdpurple!10}}, onslide={<4>{fill=cdorange!20}}] (0,1) rectangle ++(2,1) node[midway] {(2,1)};}
				
				\only<5-18>{\draw[onslide={<5>{fill=cdpurple!10}}, onslide={<18>{fill=cdorange!10}}] (0,1) rectangle ++(2,1) node[midway] {(9,2)};}
				\only<5,6>{\draw[onslide={<5>{fill=cdpurple!10}}, onslide={<6>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(3,2)};}
				
				\only<7,8>{\draw[onslide={<7>{fill=cdpurple!10}}, onslide={<8>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(4,3)};}
				
				\only<9,10>{\draw[onslide={<9>{fill=cdpurple!10}}, onslide={<10>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(5,4)};}
				
				\only<11,12>{\draw[onslide={<11>{fill=cdpurple!10}}, onslide={<12>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(6,5)};}
				
				\only<13,14>{\draw[onslide={<13>{fill=cdpurple!10}}, onslide={<14>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(7,6)};}
				
				\only<15,16>{\draw[onslide={<15>{fill=cdpurple!10}}, onslide={<16>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(8,7)};}
				
				\only<17,18>{\draw[onslide={<17>{fill=cdpurple!10}}, onslide={<18>{fill=cdorange!20}}] (0,2) rectangle ++(2,1) node[midway] {(9,8)};}
