...
%        \draw[help lines] (0,0) grid (7,2);
        ...
        \terminalRel{A-b}{$b$}{below of=A-below}
		...
		\draw[thick, rounded corners=1.5ex] (alt-start) -- (A-starta) -- (alt-curve) -- coordinate[midway](A-startb) (A-below);
        ...
        coordinate (alt-end) at (\x2 + 1em, \y2);
        %	
        \draw[thick, rounded corners=1.5ex] (A-below) -- coordinate[midway](A-bend) (alt-curve) -- (A-cend) -- (alt-end);
        
        
        \loopleft{A-b}{A-startb};
        \loopright{A-bend}{A-b};
        

       
        \coordinate (B-start) at (-1,-3); % [below of=A-start] {};
        \coordinate (B-end) at (5,-3); % [below of=A-end] {};
        
        \node () [left=0.5em of B-start] {$B$:};  
        
        \terminal{B-d}{$d$}{(0,-3)}
        \nonterminal{B-B}{$B$}{(2,-3)}
        \terminal{B-c}{$c$}{(4,-3)}   
